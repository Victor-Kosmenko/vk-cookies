...
class Vk_cookies_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'vk_cookies'));
        }
        ...
        $settingsGroup = get_class($this) . '-settings-group';
        ob_start();
        include $this->getPluginDir() . "/assets/templates/admin.php";
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'vk_cookies');
            case 'false':
                return __('false', 'vk_cookies');

            case 'Administrator':
                return __('Administrator', 'vk_cookies');
            case 'Editor':
                return __('Editor', 'vk_cookies');
            case 'Author':
                return __('Author', 'vk_cookies');
            case 'Contributor':
                return __('Contributor', 'vk_cookies');
            case 'Subscriber':
                return __('Subscriber', 'vk_cookies');
            case 'Anyone':
                return __('Anyone', 'vk_cookies');
        }
        return $optionValue;
    }
